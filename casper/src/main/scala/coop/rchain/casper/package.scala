...
import coop.rchain.casper.util.comm.{CommUtilSyntax, TransportLayerSyntax}
...
package object casper {
  ...
  // Casper syntax
  object syntax extends CommUtilSyntax with BlockStoreSyntax with TransportLayerSyntax
}
